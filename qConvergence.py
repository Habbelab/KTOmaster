...
class InvestorForecast:
    ...
    def forecast(self, old_y, new_y, q):
        ...
        Returns:
            ...
            Investor's belief in q-value for the coming period
    ...
    def convergence(self, old_y, new_y, conDetails = True):
        ...
        Returns:
            ...
            Convergence of investor's belief in q-value
    ...
    def simulate(self, n, simDetails = True):
        ...
        Returns:
            ...
            Simulated q-value for the coming period, depending on previous- and current periods q-value.
